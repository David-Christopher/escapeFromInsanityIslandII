...
import byui.cit260.escapeFromInsanityIsland.control.RaftManufacture;

/**
 *
 * @author andrenell
 */
public class ConstructRaftView extends View{   
   
    public ConstructRaftView() {
        super("\n"
                + "\n***************************************************************"
    ...
    public boolean doAction(String value) {
        value.toUpperCase(); // convert choice to upper case
            ...
            RaftManufacture raftManufacture = new RaftManufacture();
            if(raftManufacture.testTotalVine(shortLogs, longLogs, strands)){
