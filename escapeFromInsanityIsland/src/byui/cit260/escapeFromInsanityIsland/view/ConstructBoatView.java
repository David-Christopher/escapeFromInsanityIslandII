...
public class ConstructBoatView {
    ...
    public void ConstructBoatView() {
        ...
        public boolean doAction(int shortLogs, int longLogs, int strands){
            ...
            // prompt for responses to qty of each
            
            int result1 = BoatManufacture.testTotalVine(shortLogs, longLogs
            ,strands);
            ...
            if (result1 == -1){
                ...
                System.out.println("Correct. You need 3 Short Logs, 5 Long Logs,"
                        + "and each 6ft strand must have 3 braids");
                return true;
            }
            return false;
        }  
        ...
        while (!valid){
            // get entered inputs from the keyboard
